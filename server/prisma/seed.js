...
async function seed() {
  ...
  const kyle = await prisma.user.create({ data: { name: "Kyle", email: "kyle@email.com", password:"abcdefgh" } })
  const sally = await prisma.user.create({ data: { name: "Sally", email: "sally@email.com", password:"abcdefgh" } })
